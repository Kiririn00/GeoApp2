...
//action
	...
	public function Register(){
		...
		//get post data case
			...
			//save image
			$DisplayFilename = 'img/'.$PenName.'_display.jpg';
			...
			$this->set('DisplayImage',$PenName.'_display.jpg');
	...
	public function Login($error_message = null){
		
		$this->set('UserId',"");
		$this->set('check',1);
		
		//show error message when session time out
